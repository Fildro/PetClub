...
class MedicosControllerTest < ActionController::TestCase
  ...
  test "should create medico" do
    assert_difference('Medico.count') do
      post :create, medico: { appm: @medico.appm, dnim: @medico.dnim, especialidadm: @medico.especialidadm, nombrem: @medico.nombrem }
    end
  ...
  test "should update medico" do
    patch :update, id: @medico, medico: { appm: @medico.appm, dnim: @medico.dnim, especialidadm: @medico.especialidadm, nombrem: @medico.nombrem }
    assert_redirected_to medico_path(assigns(:medico))
  end
