...
class MedicosControllerTest < ActionController::TestCase
  ...
  test "should create medico" do
    assert_difference('Medico.count') do
      post :create, medico: { apm: @medico.apm, app: @medico.app, dni: @medico.dni, especialidad: @medico.especialidad, nombre: @medico.nombre }
    end
  ...
  test "should update medico" do
    patch :update, id: @medico, medico: { apm: @medico.apm, app: @medico.app, dni: @medico.dni, especialidad: @medico.especialidad, nombre: @medico.nombre }
    assert_redirected_to medico_path(assigns(:medico))
  end
