...
class ServiciosControllerTest < ActionController::TestCase
  ...
  test "should create servicio" do
    assert_difference('Servicio.count') do
      post :create, servicio: { cliente: @servicio.cliente, mascota: @servicio.mascota, medico: @servicio.medico, nombre: @servicio.nombre, obs: @servicio.obs, precio: @servicio.precio, tipo: @servicio.tipo }
    end
  ...
  test "should update servicio" do
    patch :update, id: @servicio, servicio: { cliente: @servicio.cliente, mascota: @servicio.mascota, medico: @servicio.medico, nombre: @servicio.nombre, obs: @servicio.obs, precio: @servicio.precio, tipo: @servicio.tipo }
    assert_redirected_to servicio_path(assigns(:servicio))
  end
