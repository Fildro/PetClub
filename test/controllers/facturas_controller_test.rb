...
class FacturasControllerTest < ActionController::TestCase
  ...
  test "should create factura" do
    assert_difference('Factura.count') do
      post :create, factura: { cliente_id: @factura.cliente_id, fecha: @factura.fecha, medico_id: @factura.medico_id }
    end
  ...
  test "should update factura" do
    patch :update, id: @factura, factura: { cliente_id: @factura.cliente_id, fecha: @factura.fecha, medico_id: @factura.medico_id }
    assert_redirected_to factura_path(assigns(:factura))
  end
