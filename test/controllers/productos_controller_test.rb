...
class ProductosControllerTest < ActionController::TestCase
  ...
  test "should create producto" do
    assert_difference('Producto.count') do
      post :create, producto: { categoriap: @producto.categoriap, nombrep: @producto.nombrep, precostop: @producto.precostop, prevenp: @producto.prevenp, stockp: @producto.stockp, unidadmedidap: @producto.unidadmedidap }
    end
  ...
  test "should update producto" do
    patch :update, id: @producto, producto: { categoriap: @producto.categoriap, nombrep: @producto.nombrep, precostop: @producto.precostop, prevenp: @producto.prevenp, stockp: @producto.stockp, unidadmedidap: @producto.unidadmedidap }
    assert_redirected_to producto_path(assigns(:producto))
  end
