...
class CitaControllerTest < ActionController::TestCase
  ...
  test "should create citum" do
    assert_difference('Citum.count') do
      post :create, citum: { cliente: @citum.cliente, date: @citum.date, mascota: @citum.mascota, medico: @citum.medico, obs: @citum.obs, time: @citum.time }
    end
  ...
  test "should update citum" do
    patch :update, id: @citum, citum: { cliente: @citum.cliente, date: @citum.date, mascota: @citum.mascota, medico: @citum.medico, obs: @citum.obs, time: @citum.time }
    assert_redirected_to citum_path(assigns(:citum))
  end
